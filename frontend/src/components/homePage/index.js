        ...
        <>
            ...
            <div className='homeCard'>
                {chairData.map((chair, idx) => (
                    <motion.a href={`/chairs/${chair.id}`} className='homeDiv' key={idx} key={idx} initial={{opacity: 0, translateY: 50}} animate={{opacity: 1, translateY: 0}} transition={{duration: 1.5}}>
